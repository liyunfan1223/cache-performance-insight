...
if __name__ == '__main__':
    ...
    for trace in TRACES_LIST:
        ...
        # params_list = [20, 4, 10, 4, 0.1, 20000, 0.25, 0.01, 0.01, 10000]
        ...
        #
        # params_list = [20, 4, 10, 4, 1.0, 20000, 0.25, 0.01, 0.01, 10000]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC2")

        # params_list = [20, 4, 10, 4, 1.0, 20000, 1.0, 0.01, 0.01, 10000]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        ...
        #
        # params_list = [20, 4, 10, 4, 1.0, 20000, 0.5, 0.01, 0.01, 1]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        ...
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC6")

        # params_list = [20, 4, 10, 1, 1.0, 20000, 0.5, 0.01, 0.01, 5]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC7")
        #
        # params_list = [20, 4, 10, 2, 1.0, 20000, 0.5, 0.01, 0.01, 5]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC8")
        #
        # params_list = [20, 4, 10, 1, 1.0, 20000, 1.0, 0.01, 0.01, 5]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC9")

        # params_list = [20, 4, 10, 1, 1.0, 20000, 1.0, 0.01, 0.01, 1]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        ...
        # params_list = [100, 4, 10, 1, 1.0, 20000, 0.5, 0.01, 0.01, 1]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC14")
        #
        # params_list = [100, 4, 10, 4, 1.0, 20000, 0.5, 0.01, 0.01, 10000]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC15")
        #
        # params_list = [20, 4, 10, 8, 1.0, 20000, 0.5, 0.01, 0.01, 10000]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC16")
        #
        # params_list = [100, 4, 10, 4, 1.0, 20000, 0.5, 0.01, 0.01, 5]
        # runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        # rgc_result = runner.get_hit_rate_list()
        # ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
        # stats.statistic(lru_result, rgc_result, "New-RGC17")

        params_list = [20, 4, 10, 4, 1.0, 20000, 0.5, 0.01, 0.01, 5, 1]
        runner = MultiTestRunner(['RGC'], BUFFER_SIZE_LIST, trace_file, params_list)
        rgc_result = runner.get_hit_rate_list()
        ax.plot(BUFFER_SIZE_LIST, rgc_result, label=f'RGC {params_list}', marker='+', linestyle='-')
