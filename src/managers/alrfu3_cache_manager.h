...
#ifndef CACHE_PERFORMANCE_INSIGHT_ALRFU3_CACHE_MANAGER_H
#define CACHE_PERFORMANCE_INSIGHT_ALRFU3_CACHE_MANAGER_H

class ALRFU3CacheManager: public CacheManager {
public:
    ALRFU3CacheManager(int32_t buffer_size, int32_t update_interval = 20000,
...
//        cur_decay_ratio_exp_ = log(pow(0.5, (double)1.0 / (cur_half_ * buffer_size)));
    ...
    ~ALRFU3CacheManager() override = default;
...
#endif //CACHE_PERFORMANCE_INSIGHT_ALRFU3_CACHE_MANAGER_H
