...
#ifndef CACHE_PERFORMANCE_INSIGHT_DYNAMIC_DECAY_HEAP_H
#define CACHE_PERFORMANCE_INSIGHT_DYNAMIC_DECAY_HEAP_H
...
#endif //CACHE_PERFORMANCE_INSIGHT_DYNAMIC_DECAY_HEAP_H
